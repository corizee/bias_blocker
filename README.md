...
* [Large language models show amplified cognitive biases in moral decision-making by Cheung et al. 2025](https://www.pnas.org/doi/10.1073/pnas.2412015122)
* [The Bias is in the Details: An Assessment of Cognitive Bias in LLMs by Knipper et al. 2025] (https://arxiv.org/abs/2509.22856)

## What's the Problem?
Decision quality suffers from biased advice. If employees are using LLMs and LLM-powered agents to help make decisions, the degraded decision quality becomes an issue at scale. That's a governance issue, and CIOs should be concerned.
